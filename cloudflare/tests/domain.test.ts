...
const recurring = { title:"Hourly report", kind:"recurring", schedule:{type:"cron",expression:"0 * * * *",timezone:"Asia/Hong_Kong"}, prompt:"Summarize updates", tools:["none"], notify:true } as const;
